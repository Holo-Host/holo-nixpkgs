...
@click.option('--ui_url', help='Hosted happ UI url')
@click.pass_context
def register_happ(ctx, bundle_url, ui_url):
    print(request(ctx, 'POST', '/register_happ',  data=json.dumps({'bundleUrl': bundle_url, 'uiUrl': ui_url })))
