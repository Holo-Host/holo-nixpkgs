  ...
  services.configure-holochain = lib.mkDefault {
    ...
    install-list = {
      core_happs = [
       {
         app_id = "core-app";
         bundle_url = "https://holo-host.github.io/holo-hosting-app-rsm/releases/downloads/v0.1.0-alpha12/core-app.0_1_0_alpha12.happ";
       }
       {
      ...
      self_hosted_happs = [
        {
          bundle_url = "https://github.com/holochain/elemental-chat/releases/download/v0.2.0-alpha9/elemental-chat.0_2_0_alpha9.happ";
